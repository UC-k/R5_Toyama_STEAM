...
1. GUI<br>
   &emsp;1-1. GUIとは<br>
   &emsp;1-2. tkinterとは<br><br>
2. 画面の作成と設定<br><br>
3. キャンバスの作成と画像の配置<br>
   &emsp;3-1. キャンバスの作成<br>
   &emsp;3-2. キャンバスに画像を配置<br>
   &emsp;3-3. キャンバスに画像を配置するまでの流れ<br><br>
4. 画面にテキストを入れる<br><br>
5. ボタンと関数<br>
   &emsp;5-1. ボタン<br>
   &emsp;5-2. 関数<br>
   &emsp;5-3. ボタンを押したら関数が実行される仕組み<br><br>
6. チェックボタンとウィジェット変数<br>
   &emsp;6-1. チェックボタンを配置する<br>
   &emsp;6-2. 複数個のチェックボタンを配置する<br><br>
7. 診断画面を作成する<br>
